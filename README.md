...
Leveraging code completion tools during the exercise is permitted. However, you should be prepared to provide explanations for any code generated by such tools.
