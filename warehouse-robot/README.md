...
For convenience the robot moves along a grid in the roof of the warehouse and we have made sure that all of our warehouses are built so that the dimensions of the grid can be considered as an integer. We've also made sure that all our warehouses are aligned along north-south and east-west axes.
